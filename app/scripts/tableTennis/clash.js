(function (angular, k, _) {
    ...
    angular.module('ScoreKeeper.TableTennis')
		.service('Clash', ['ScoreProjector', 'PersistenceToken', function ClashService(ScoreProjector, PersistenceToken) {
		    ...
		    this.persistence = new PersistenceToken();
		    ...
		    this.revive = function (dto) {
		        ...
		        if (dto.persistence.id) {
		            this.persistence = new PersistenceToken(dto.persistence.id, dto.persistence.check);
		        }
		    };
		}]);
